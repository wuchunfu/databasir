...
public class SchemaSourceMetaRule implements Serializable {
    ...
    public SchemaSourceMetaRule(SchemaSourceMetaRule value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("SchemaSourceMetaRule (");
