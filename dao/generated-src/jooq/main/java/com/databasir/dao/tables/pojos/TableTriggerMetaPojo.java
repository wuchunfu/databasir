...
public class TableTriggerMetaPojo implements Serializable {
    ...
    public TableTriggerMetaPojo() {}

    public TableTriggerMetaPojo(TableTriggerMetaPojo value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("TableTriggerMetaPojo (");
