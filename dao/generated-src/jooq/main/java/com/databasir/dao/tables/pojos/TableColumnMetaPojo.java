...
public class TableColumnMetaPojo implements Serializable {
    ...
    public TableColumnMetaPojo() {}

    public TableColumnMetaPojo(TableColumnMetaPojo value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("TableColumnMetaPojo (");
