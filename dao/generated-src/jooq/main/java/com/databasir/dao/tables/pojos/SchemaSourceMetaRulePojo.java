...
public class SchemaSourceMetaRulePojo implements Serializable {
    ...
    public SchemaSourceMetaRulePojo() {}

    public SchemaSourceMetaRulePojo(SchemaSourceMetaRulePojo value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("SchemaSourceMetaRulePojo (");
