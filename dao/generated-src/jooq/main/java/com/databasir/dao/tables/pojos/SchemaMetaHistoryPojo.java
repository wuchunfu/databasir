...
public class SchemaMetaHistoryPojo implements Serializable {
    ...
    public SchemaMetaHistoryPojo() {}

    public SchemaMetaHistoryPojo(SchemaMetaHistoryPojo value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("SchemaMetaHistoryPojo (");
